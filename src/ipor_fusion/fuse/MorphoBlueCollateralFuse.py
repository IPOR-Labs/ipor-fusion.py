...
class MorphoBlueCollateralFuse:
    ENTER = "enter"
    EXIT = "exit"
    ...
    def supply_collateral(
        ...
        enter_data = MorphoBlueCollateralFuseEnterData(market_id, amount)
    ...
    def withdraw_collateral(
        ...
        if self._fuse_address is None:
            raise ValueError("fuseAddress is required")
        exit_data = MorphoBlueCollateralFuseExitData(market_id, amount)
        return FuseAction(self._fuse_address, exit_data.function_call())


class MorphoBlueCollateralFuseEnterData:
...
class MorphoBlueCollateralFuseExitData:
    def __init__(self, market_id: MorphoBlueMarketId, amount: Amount):
        self.market_id = market_id
        self.amount = amount
