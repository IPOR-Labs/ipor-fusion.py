...
# Arbitrum vault addresses
ARBITRUM_PILOT_V3_PLASMA_VAULT = Web3.to_checksum_address(
    "0x862644e627eb0cdeff10f234bea51b8dfd6ea8e8"
)
ARBITRUM_PILOT_V4_PLASMA_VAULT = Web3.to_checksum_address(
    "0x707A88CDF02e2b8c98Aff08Be245B835E2784C8b"
)
ARBITRUM_PILOT_V5_PLASMA_VAULT = Web3.to_checksum_address(
    "0x3F97CEa640B8B93472143f87a96d5A86f1F5167F"
)
ARBITRUM_PILOT_SCHEDULED_PLASMA_VAULT = Web3.to_checksum_address(
    "0xAC62eDcdA14aF2e2547F85D56EB2CE36D11333DA"
)


# Arbitrum fuse addresses (chain 42161)
...
ARBITRUM_ERC4626_SUPPLY_FUSE_MARKET_ID_3 = Web3.to_checksum_address(
...
ARBITRUM_ERC4626_SUPPLY_FUSE_MARKET_ID_5 = Web3.to_checksum_address(
...
# V3 vault-specific fuses (0x862644...) - different deployments than V4/V5
...
# V4 vault-specific fuses (0x707A88...) - different deployments than V5
...
BASE_MORPHO_COLLATERAL_FUSE = Web3.to_checksum_address(
    "0xde3fd3a25534471e92c5940d418b0582802b17b6"
)
