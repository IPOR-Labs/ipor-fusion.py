...
from ipor_fusion import PlasmaVault, ERC20, RewardsManager
    ...
    def test_should_claim_morpho_rewards(self):
        ...
        with patch("requests.get") as mock_get:
            ...
            for dist in distributions:
                ...
                before = ERC20(forked_ctx, dist.rewards_token_address).balance_of(
                    rewards.address
                )

                rewards.claim_rewards([claim_action])

                after = ERC20(forked_ctx, dist.rewards_token_address).balance_of(
                    rewards.address
                )
